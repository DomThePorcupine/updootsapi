...
func main() {
	...
	c := cors.New(cors.Options{
		AllowedOrigins: []string{"http://192.168.66.50:8100/","http://127.0.0.1:8100","https://app.updoot.us","http://localhost:8080", "http://127.0.0.1:8080/", "http://localhost:3000/", "https://updoot.us"},
